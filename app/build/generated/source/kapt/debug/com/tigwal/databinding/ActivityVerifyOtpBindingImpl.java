...
public class ActivityVerifyOtpBindingImpl extends ActivityVerifyOtpBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.llPinView, 5);
        sViewsWithIds.put(R.id.pinviewOTP, 6);
        sViewsWithIds.put(R.id.txtDontReceiveCOde, 7);
    ...
    private ActivityVerifyOtpBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 0
            ...
            , (com.goodiebag.pinview.Pinview) bindings[6]
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewmodel == variableId) {
            setViewmodel((com.tigwal.ui.view_model.otp.VerifyOtpViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewmodel(@Nullable com.tigwal.ui.view_model.otp.VerifyOtpViewModel Viewmodel) {
