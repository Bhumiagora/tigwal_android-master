...
public class ActivityChatListBindingImpl extends ActivityChatListBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.layoutNotFound, 4);
        sViewsWithIds.put(R.id.recyclerChat, 5);
    }
    // views
    @NonNull
    ...
    private ActivityChatListBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 0
            , (bindings[4] != null) ? com.tigwal.databinding.LayoutDataNotFoundBinding.bind((android.view.View) bindings[4]) : null
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewmodel == variableId) {
            setViewmodel((com.tigwal.ui.view_model.chatlist.ChatListViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewmodel(@Nullable com.tigwal.ui.view_model.chatlist.ChatListViewModel Viewmodel) {
