...
public class FragmentCartBindingImpl extends FragmentCartBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.rvCart, 5);
        sViewsWithIds.put(R.id.btnContinueShopping, 6);
        sViewsWithIds.put(R.id.btn_check_order, 7);
    }
    // views
    @NonNull
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewmodel == variableId) {
            setViewmodel((com.tigwal.ui.view_model.cart.CartViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewmodel(@Nullable com.tigwal.ui.view_model.cart.CartViewModel Viewmodel) {
